...
import static com.srtianxia.bleattendance.rx.RxPeripheralConnection.ConnectionState.CONNECTED;
import static com.srtianxia.bleattendance.rx.RxPeripheralConnection.ConnectionState.DISCONNECTED;
...
public class RxPeripheralAdvResult implements RxPeripheralConnection {
    ...
    private BehaviorSubject<ConnectionState> behaviorSubject = BehaviorSubject.create(DISCONNECTED);

    public RxPeripheralAdvResult(AdvertiseSettings advertiseSettings) {
        ...
        public void onConnectionStateChange(BluetoothDevice device, final int status, int newState) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                if (newState == BluetoothGatt.STATE_CONNECTED) {
                    ...
                    behaviorSubject.onNext(DISCONNECTED);
                }
            } else {
                mBluetoothDevices.remove(device);
            }
    ...
    public void initConnection() {
        ...
        mGattServer = getBluetoothManager().openGattServer(BleApplication.getContext(),
                mGattServerCallback);
    ...
    private BluetoothManager getBluetoothManager() {
        return (BluetoothManager) BleApplication.getContext()
